            ...
            <div class="card rounded-0">
                <div class="card-body">
                    ...
                    <dl>
                        ...
                        <dd class="pl-3">anirudh@gmail.com</dd>
                        <!-- <?= $_settings->info('email') ?> -->
                        <dt class="text-muted">Telephone #</dt>
                        <dd class="pl-3">0240-392524</dd>
                        <!-- <?= $_settings->info('phone') ?> -->
                        <dt class="text-muted">Mobile #</dt>
                        <dd class="pl-3">+919604002595</dd>
                        <!-- <?= $_settings->info('mobile') ?> -->
                        <dt class="text-muted">Address</dt>
                        <dd class="pl-3">Shri Guru Gobind Singhji Institute of Engineering & Technology Nanded,Maharahshtra, India</dd>
